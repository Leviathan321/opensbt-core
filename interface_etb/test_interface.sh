...
SCENARIO=2 # the SUT/Scenario/Experiment to be executed; we can also pass directly a file to the scenario: 
           # number corresponds to default experiments defined in OpenSBT

MIN=(1 2 3) # the lower bounds of the search space
MAX=(11 12 13)  # the upper bounds of the search space
